...
parser.add_option("-p", "--path", dest="test_path",default='/home/rod/Desktop/Research/RodNet/Datasets/FRCNNTest', help="Path to test data.")
#parser.add_option("-p", "--path", dest="test_path",default='/home/rod/Desktop/Research/RodNet/Datasets/FRCNNTest', help="Path to test data.")
...
"""THIS IS A TEMPORARY FIX TO TEST ON RESNET50"""
import keras_frcnn.resnet as nn
...
C.model_path = '/home/rod/Desktop/Research/RodNet/Architectures/Keras-FasterRCNN-master/Models/v9/model_frcnn.hdf5'
...
for idx, img_name in enumerate(sorted(os.listdir(img_path))):
    ...
    R = roi_helpers.rpn_to_roi(Y1, Y2, C, 'tf', overlap_thresh=0.99) #Can edit Roi threshold here, seems that the higher it is the more picky it is
    ...
    for key in bboxes:
        ...
        for jk in range(new_boxes.shape[0]):
            #print(type(new_probs[jk]))
            #if(new_probs[jk] > 0.97):
