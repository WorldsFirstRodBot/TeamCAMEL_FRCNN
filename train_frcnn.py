...
parser.add_option("-p", "--path", dest="train_path", help="Path to training data.", default='/home/rod/Desktop/Research/RodNet/Datasets/WiderFace/wider_face_split/RSwiderFaceTrain.txt')
...
data_gen_train = data_generators.get_anchor_gt(train_imgs, classes_count, C, nn.get_img_output_length, imgFormat, mode='train')
#X, Y, img_data = data_generators.get_anchor_gt(train_imgs, classes_count, C, nn.get_img_output_length, imgFormat, mode='train')
#data_gen_test = data_generators.get_anchor_gt(test_imgs, classes_count, C, nn.get_img_output_length, imgFormat, mode='test')
...
for epoch_num in range(num_epochs):
    ...
    while(True):   
        try:
            ...
            R = roi_helpers.rpn_to_roi(P_rpn[0], P_rpn[1], C, imgFormat, use_regr=True, overlap_thresh=0.7, max_boxes=300)
